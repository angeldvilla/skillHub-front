  ...
  return (
    <div className="flex flex-wrap justify-around ml-12 font-serif">
      <div className="justify-around m-64 rounded-md grid grid-cols-4 gap-32 mt-10">
        {work.map(({ _id, title, image, address, phone,ability }) => (
          <div key={_id} className="bg-white p-px-12 rounded-lg shadow-lg w-64 flex flex-col">
            ...
            <h3 className="text-black text-center mb-4">address: {address}</h3>
            <h3 className="text-black text-center mb-4">Phone: {phone}</h3>
