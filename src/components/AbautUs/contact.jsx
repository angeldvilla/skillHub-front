...
const people = [
      ...
      },
  {
    ...
    imageUrl:"https://res.cloudinary.com/dvr9giaia/image/upload/w_1000,c_fill,ar_1:1,g_auto,r_max,bo_5px_solid_red,b_rgb:262c35/v1691980631/Screenshot_96_w9pqpw.png"
  },
    ...
    <div>
      <div className="flex flex-col flex-wrap items-center md:flex-nowrap md:flex-row md:justify-between md:mx-8 lg:mx-12 xl:justify-between xl:mx-32 2xl:mx-48">
        ...
        data-aos-duration="2000"> 
           <Link to={"/home"}>
           <img className="logoSkill" src={"https://res.cloudinary.com/dvr9giaia/image/upload/v1691931744/LogostiposPropios/skillHub_d22v7s.jpg"} alt="imagenLogoSkillHub"/>
      </Link></div>
</div>
        </div>
        <ul
