    ...
    <div>
      <div className='flex flex-col items-center justify-center h-screen font-mono'>
        ...
        <div className='flex flex-col justify-center items-center bg-sky-950 p-10 rounded-lg'>
          ...
          <div className='flex justify-center gap-5 h-10 w-auto'>
            <img
              src='https://raw.githubusercontent.com/devicons/devicon/1119b9f84c0290e0f0b38982099a2bd027a48bf1/icons/google/google-original.svg'
              alt='instagram-logo'
              className='hover:cursor-pointer transition'
            />
            <img
              src='https://raw.githubusercontent.com/devicons/devicon/1119b9f84c0290e0f0b38982099a2bd027a48bf1/icons/facebook/facebook-plain.svg'
              alt='facebook-logo'
              className='hover:cursor-pointer transition'
            />
            <img
