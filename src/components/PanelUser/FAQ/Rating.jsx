      ...
      <div className="flex-1 flex justify-center items-center py-16">
        ...
        >
          ...
          <p className="text-gray-600">
            ¡Hola {user?.firstName}! Nuestro equipo está aquí porque estamos
            interesados en conocer tu opinion a cerca de SkillHub. ¡Ayúdanos a
            mejorar! Selecciona una puntuación y envía tu calificación.
          </p>
          ...
          <p>
            Valoramos tus comentarios y queremos asegurarnos de que tu voz sea
            escuchada. Si tienes alguna opinión, sugerencia o simplemente deseas
            compartir tu experiencia, no dudes en escribir un mensaje. Tu
            retroalimentación es invaluable para nosotros y nos ayuda a mejorar
            continuamente.
          </p>
        </motion.div>
      </div>
