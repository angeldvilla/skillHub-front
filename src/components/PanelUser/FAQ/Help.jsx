      ...
      <div className="bg-white rounded-lg shadow-md w-3/6 p-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            ¡Bienvenido a nuestro Centro de Ayuda! Aquí encontrarás información
            útil, consejos y recursos para aprovechar al máximo nuestros
            servicios. Explora nuestras guías y soluciones para resolver
            tus dudas y mejorar tu experiencia.
          </p>
        </div>
        <div className="mb-6">
          <h3 className="text-lg font-semibold mb-2">Planes de Suscripción</h3>
          <p className="text-gray-600">
            Si estás interesado en nuestros servicios premium, consulta nuestros
        ...
        <div>
          <h3 className="text-lg font-semibold mb-2">¿Necesitas Ayuda Personalizada?</h3>
