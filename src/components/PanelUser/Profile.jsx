            ...
            <div className="flex-grow mx-auto">
              <div className="flex flex-col justify-center items-center mt-4 mb-20 bg-gray-200 rounded-lg shadow-md p-6">
                ...
                <p className="text-md text-gray-600 text-center">
                  Esta es la cuenta administrativa de SkillHub. Puedes
                  Inhabilitar usuarios y trabajos que incumplan con las
                  politicias de la empresa además de otras funciones exclusivas
                </p>
              </div>
              <UserProfileInfo />
            </div>
          ...
          <div className="p-5 max-w-lg mx-auto w-full">
            <div className="flex-grow mx-auto">
              ...
              <div className="flex flex-col justify-center items-center mt-4 mb-20 bg-gray-200 rounded-lg shadow-md p-6">
                ...
                <p className="text-md text-gray-600 text-center">
                  Al eliminar tu cuenta, no volverás a tener acceso a SkillHub
                  con este correo. Ten en cuenta que tu historial de trabajos,
                  servicios, y suscripciones se eliminarán automáticamente
                  después de cierto tiempo.
                </p>
                <div className="mt-4">
                  <Button color="red" size="md" onClick={handleOnClick}>
                    Eliminar mi Cuenta
                  </Button>
                </div>
