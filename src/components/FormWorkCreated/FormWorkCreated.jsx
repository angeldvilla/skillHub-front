...
export default function FormCreateWork() {
  ...
  const trabajoFiltrado = TodosLostrabajos.find(
    (trabajo) => trabajo._id === id
  ); // Usa find en lugar de filter para obtener un solo objeto
  let numericPrice;
    ...
    <div>
      ...
      (usuario.length === 1
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="my-7">
            <Card shadow={false} className="bg-[#f8fafc] px-4 py-2 w-96">
              <div className="">
