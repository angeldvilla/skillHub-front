...
const LandingPage = () => {
    ...
    <div>
        ...
        <img src={logoSkillHub} 
        className="className='absolute -top-16 rounded-full border-4 bg-sky-900 border-sky-800' "
        alt='skillHub Logo'/>
        </div>
        <span>About Us </span> 
        <span> Contact </span>
            <Link to='/signin' className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">
             Login
            </Link>
        </nav>
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
            ...
            <Link to='/signup' color="bg-blue">Sign Up Here</Link>
        </div>
