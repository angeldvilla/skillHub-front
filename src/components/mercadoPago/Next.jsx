  ...
  return (
    ...
    >
      <img
        ...
        src={logoSkillHub}
        style={{ width: '200px', marginBottom: '21px', borderRadius: '50%' }}
      />
      <p
        className="title"
        style={{
      ...
      >
        En SkillHub, nos complace brindarte una experiencia excepcional.
        Contáctanos ante cualquier consulta o inquietud.
      </p>
      {datos === null ? (
        <Loader />
      ) : (
