...
const Next = () => {
  ...
  return (
    <div className="container" style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", minHeight: "100vh", backgroundColor: "black", color: "lightblue" }}>
      ...
      <p className="title" style={{ fontSize: "24px", fontWeight: "bold", marginBottom: "20px", width: "80%", textAlign: "center"}}>
        ¡Listo para llevar tus propuestas al mundo!
      </p>
      <p className="description" style={{ fontSize: "18px", marginBottom: "20px", width: "80%" }}>
        En SkillHub, nos complace brindarte una experiencia excepcional. Contáctanos ante cualquier consulta o inquietud.
      </p>
      {datos === null ? (
        <Loader />
      ) : (
        <button className="next-button" style={{ color: "white", border: "1px solid lightblue", width: "200px" }} onClick={handleGuardarDatos}>
          NEXT
        </button>
      )}
    </div>
