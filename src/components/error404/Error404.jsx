      ...
      <div style={containerStyles}>
        <div className="kode-content">
          <div className="container">
            <div className="error-404" style={error404Styles}>
              <h2 style={h2Styles}>UPS</h2>
              <div className="page-404" style={page404Styles}>
              ...
              <h3 style={paragraphStyles}>
                No pudimos encontrar la página que está buscando. Intente
                iniciar sesión y verifique la URL que ingresó.
              </h3>
              <NavLink to="/signin">
                {' '}
                {/* Cambia './signin' a '/signin' */}
                <button className="go-back" style={goBackStyles}>
                  Inicia sesión
                </button>
              </NavLink>
            </div>
